...
Next step is to determine in config maven_logger.rb file what generates an event in your various classes.
...
and add description text to maven_logger.en.yml that should be written in description in LoggerEntry
...
For example to save count of results:
